...
dataset_size=2;% the number of used images in the dataset
...
if(Test_naive_method==true)
    ...
    if(unmixing==true)
        ...
        [mean_PSNR]=evaluate_on_Tokyo_Demosaicing(num_band,sz,smp_scenario,num_obs_pxl,GRMR_params,WNMF_params,dataset_size);
        fprintf('\n');
        fprintf('Method  D_PSNR  \n');
        fprintf('GMRM   | %.1f   \n',mean_PSNR(1));
        fprintf('BTES   | %.1f   \n',mean_PSNR(2));
