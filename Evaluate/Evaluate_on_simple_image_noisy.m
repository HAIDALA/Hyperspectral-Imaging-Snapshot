function [mean_PSNR,mean_SAM, exec_time,std_PSNSR,std_SAM,mean_MSE,mean_SIR,mean_MER,mean_U_PSNR,mean_SSIM,mean_RMSE,mean_MRSA]=Evaluate_on_complex_image_noisy(num_band,sz,smp_scenario,num_obs_pxl,GRMR_params,WNMF_params,unmixing,num_of_experiments)


% Test demosaicing and unmixing on Simple Image
% Oct 6 2022 - Kinan ABBAS for ICASSP 2023 conference
...
tables.SAM=T_SAM;
tables.PSNR=T_PSNR;
write_results_to_file('SNR_Simple_Image',num_band,tables);
