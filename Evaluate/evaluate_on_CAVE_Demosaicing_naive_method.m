...
% Test demosaicing performance on CAVE dataset for Naive WNMF
% The goal of this file is to run the expirment in a parallel way to run on
% Calculco
% Author: Kinan ABBAS
...
% The rank of images in Cave dataset
Cave_Rank = [5     3     5     5     3     3     4     4     5     5     4     5     4     5     5     3     3     5     3     5     3     5     5     4     5     5     5     5     5     5     5     5];
...
%     r=GetCaveImageRank(fname,Cave_names,Cave_Rank);
    ...
    tic;
    [I_WNMF_rec1,~,~]=Naive_WNMF(I_MOS_seq,SMP_seq,FilterPattern_Final,num_band,WNMF_params1,num_obs_pxl,I_WB,smp_scenario,r);
    WNMF1=I_WNMF_rec1;
    WNMF_toc1=toc;
    ...
    err_WB(zz)=mean(CalculatePSNR(I_WB,I_HS,num_band));
    err_WNMF1(zz)=mean(CalculatePSNR(WNMF1,I_HS,num_band));
    %% Final procesing
