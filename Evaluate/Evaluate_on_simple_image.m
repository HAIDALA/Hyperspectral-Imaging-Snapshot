function [mean_PSNR,mean_SAM, exec_time,std_PSNSR,std_SAM,mean_MSE,mean_SIR,mean_MER,mean_U_PSNR,mean_SSIM,mean_RMSE,mean_MRSA]=Evaluate_on_complex_image(num_band,sz,smp_scenario,num_obs_pxl,GRMR_params,WNMF_params,unmixing,num_of_experiments)
...
mean_SAM=[mean((err_SAM_GRMR)),err_SAM_GRMR,mean((err_SAM_WB)),mean((err_SAM_PPID)),mean((err_SAM_ItSD)),mean((err_SAM_WNMF)),mean((err_SAM_WNMF1)),mean((err_SAM_WNMF2))];
