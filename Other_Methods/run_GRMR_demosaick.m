...
%SMP_seq is the sampling matrix , size is 500*500*16*2, 
block_iter=1;
...
%numel gives the number of the items in the array, but in the case of cell array it gives the number of cells

parfor tt=1:numel(FilterPattern_lst)
    %M2 is a cell array, the cell size is 25*2
    M2=CurrBlock_lst{tt};
    %SMP is a cell array, the cell size is 25*16*2
