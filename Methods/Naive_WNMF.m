function [I_WNMF_rec,G,F] = Naive_WNMF(I_MOS_seq,SMP_seq,FilterPattern_Cell,num_band,WNMF_params,num_obs_pxl,I_WB,smp_scenario,r)
...
%% Store G and F in case of Naive NMF
G=F_New';
F=G_New';
